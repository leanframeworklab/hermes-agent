...
CURATOR_REVIEW_PROMPT = (
    ...
    "1a. DO NOT touch governance-managed runtime skills declared in "
    ".governance_manifest.json. They are deployed artifacts; inspect/report "
    "only and leave mutation to canonical deployment authority.\n"
