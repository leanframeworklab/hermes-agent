...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Governance-managed runtime skills declared in .governance_manifest.json.\n"
    "    They are deployed artifacts. Never patch, write, edit, remove, or delete\n"
    "    them in ~/.hermes/skills/. Stage a proposal with intended content, base\n"
    "    source fingerprint, origin session, and reason; canonical deployment is\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "  • Governance-managed runtime skills declared in .governance_manifest.json.\n"
    "    They are deployed artifacts. Never patch, write, edit, remove, or delete\n"
    "    them in ~/.hermes/skills/. Stage a proposal with intended content; only\n"
    "    canonical deployment may update runtime.\n"
    "  • Bundled skills (shipped with Hermes, e.g. 'hermes-agent').\n"
    "  • Hub-installed skills (installed via 'hermes skills install').\n"
    "Pinned skills (marked via 'hermes curator pin') CAN be improved — "
    "pin only blocks deletion/archive/consolidation by the curator, not "
